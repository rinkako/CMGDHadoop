package org.themoveleph.CMGDHadoopWeb.util;
...
/*
    // HIVECUBE数据读入
    public static ArrayList<String> splitInput(String filename) throws IOException {
        ...
        reader.close();
        System.out.println("Split input OK");
        return vec;
    }
*/
    ...
    public static void main(String[] args) throws Exception {
        // 读入数据
        //splitInput("naivecube.hbb/000000_0");
